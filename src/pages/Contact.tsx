...
export function Contact() {
    return (
        <div className="min-h-screen pt-[68px] bg-neutral-200 flex flex-col items-center justify-center px-6">
            <div className="max-w-3xl w-full text-center py-6">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl shadow-black/20 border border-green-700">
